...
void CContextWeather::Draw(UINT nContextNum)
{
	...
	{
		DrawText("오  전", g_wid, g_gc,  83, 20, 60, 18, g_font, 18, WHITE, TXT_HALIGN_CENTER|TXT_VALIGN_MIDDLE);		//왼쪽
		DrawText("오  후", g_wid, g_gc, 665, 20, 60, 18, g_font, 18, WHITE, TXT_HALIGN_CENTER|TXT_VALIGN_MIDDLE);		//오른쪽
	}

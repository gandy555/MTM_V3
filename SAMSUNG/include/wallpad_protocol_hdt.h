/*
	...
	패킷구조:
		...
		STX		: 0xF7
		LEN		: STX ~ ETX
		VEN		: 0x00을 제외한 Vendor ID, v2.10부터 통합ID(0x01)을 사용함
...
/*
#define HDT_USS_ARG_VALUE_DEVID_LIGHT			0x19		// 일괄소등
#define HDT_USS_ARG_VALUE_DEVID_GAS				0x1B		// 가스차단
#define HDT_USS_ARG_VALUE_DEVID_SECURITY		0x16		// 보안

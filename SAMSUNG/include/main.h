...
#define ELEVATOR_TIMER			2	//엘레베이터 주기적 상태요청 타이머
...
extern class CSerialWallPad_SNS	g_wallpad_sns;
...
extern void parking_list_update(PARKING_RES* _info);
extern int parking_list_get_item(int _idx, PARKING_RES* _dst);
extern int parking_item_to_str(int _id, UCHAR* _src, char* _dst);

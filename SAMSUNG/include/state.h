...
//	void DoChangeState(UINT state);
//	void DoChangeContext(UINT nContextNum=0); 

	void ButtonDown(UINT usGpioFlag, UINT usEventEnum);
	void ButtonUp(UINT usGpioFlag, UINT usEventEnum);

	void RecvProc(UCHAR *pPacket);
